...
//Creamos la clase local storage que permite gestionar una lista de datos guardada en el localStorage
...
class LocalStorageList {
    ...
    // - key = String. Clave que de localStorage
    // - duplicates Si se permiten o no duplicados.
    // - separator Separador entre elementos de la lista.
    // - debug Si vuelca o no información en la consola.
